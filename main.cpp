...
public:
    ...
    void show_stud() {
        ...
        for (int j = 0; j < count; j++) {
                    marks_input >> gradebook_number >> matan >> phys >> prac_tise >> inf_tech >> history >> english;
                    int tmp(1);
                    for (int i = 0; i < 7; i++) {
                    ...
                    if (tmp == 1) {
                        if (matan == 5 && phys == 5 && prac_tise == 5 && inf_tech == 5 && history == 5 && english == 5) {
                            cout << "Отличник: " << gradebook_number << " " << matan << " " << phys << " " << prac_tise << " " << inf_tech << " " << history << " " << english << endl;
                            break;
                        }
                        else if ((matan == 5 || matan == 4) && (phys == 5 || phys == 4) && (prac_tise == 5 || prac_tise == 4) && (inf_tech == 5 || inf_tech == 4) && (history == 5 || history == 4) && (english == 5 || english == 4)) {
                            cout << "Хорошист: " << gradebook_number << " " << matan << " " << phys << " " << prac_tise << " " << inf_tech << " " << history << " " << english << endl;
                            break;
                        }
                        else if (matan == 3 || phys == 3 || prac_tise == 3 || inf_tech == 3 || history == 3 || english == 3) {
                            cout << "Троечник: " << gradebook_number << " " << matan << " " << phys << " " << prac_tise << " " << inf_tech << " " << history << " " << english << endl;
                            break;
                        }
                    }
                }
    ...
    void find_M() {
        ...
        for (int i = 0; i < count; i++) {
            input >> number >> name >> surname >> patronymic >> gen_der >> day >> month >> year >> year_of_receipt >> faculty >> department >> group;
            if (gen_der == 'M') {
                show_stud();
            }
        }
    ...
    void check_marks() {
        ...
        while (!check.eof()) {
            count++;
            check >> gradebook_number >> matan >> phys >> prac_tise >> inf_tech >> history >> english;
        }
        count--;
    }
...
public:
    ...
    void write() {
        ...
        output << gradebook_number << " " << name << " " << surname << " " << patronymic << " " << gen_der << " " << day << " " << month << " " << year << " " << year_of_receipt << " " << faculty << " " << department << " " << group << endl;
...
public:
    ...
    void add_mark() {
        ...
        output << gradebook_number << " " << matan << " " << phys << " " << prac_tise << " " << inf_tech << " " << history << " " << english << endl;
        output.close();
    ...
    void delete_mark() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            input >> gradebook_number >> matan >> phys >> prac_tise >> inf_tech >> history >> english;
        ...
        for (int i = 0; i < count; i++) {
            ...
            if_rewrite >> gradebook_number >> matan >> phys >> prac_tise >> inf_tech >> history >> english;
            of_rewrite << gradebook_number << " " << matan << " " << phys << " " << prac_tise << " " << inf_tech << " " << history << " " << english << endl;
    ...
    void Change_Marks() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            else output << gradebook_number << " " << matan << " " << phys << " " << prac_tise << " " << inf_tech << " " << history << " " << english << endl;
    ...
    void Show_Marks() {
        ...
        for (int i = 0; i < count; i++) {
            input >> gradebook_number >> matan >> phys >> prac_tise >> inf_tech >> history >> english;
            cout << gradebook_number << " " << matan << " " << phys << " " << prac_tise << " " << inf_tech << " " << history << " " << english << endl;
        }
        input.close();
    }
...
public:
    ...
    int welcome() {
        ...
        while (!check.eof()) {
            count++;
            check >> gradebook_number >> name >> surname >> patronymic >> gen_der >> day >> month >> year >> year_of_receipt >> faculty >> department >> group;
        }
        count--;
    ...
    void Show_Students() {
        ...
        int counter = 0;
        for (int i = 0; i < count; i++) {
            input >> gradebook_number >> name >> surname >> patronymic >> gen_der >> day >> month >> year >> year_of_receipt >> faculty >> department >> group;


            counter++;
            cout << "(" << counter << ")" << endl;
            cout << "ФИО(пол): " << surname << " " << name << " " << patronymic << " (" << gen_der << ") " << endl;
    ...
    void Delete_Student() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if_rewrite >> gradebook_number >> name >> surname >> patronymic >> gen_der >> day >> month >> year >> year_of_receipt >> faculty >> department >> group;
            of_rewrite << gradebook_number << " " << name << " " << surname << " " << patronymic << " " << gen_der << " " << day << " " << month << " " << year << " " << year_of_receipt << " " << faculty << " " << department << " " << group << endl;
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (tmp == 1) {
                ...
                case 1:
                {
                    ...
                    cin >> surname >> name >> patronymic >> gen_der;
                    clear_all();
                    break;
                }
                case 2:
                {
                    cout << "Введите {День, Месяц, Год} - Рождения и Год По-ступления: " << endl;
                    day = protect_day();
                    month = protect_month();
                    year = protect_year();
                    year_of_receipt = protect_year();
            ...
            else output << gradebook_number << " " << name << " " << surname << " " << patronymic << " " << gen_der << " " << day << " " << month << " " << year << " " << year_of_receipt << " " << faculty << " " << department << " " << group << endl;
